...
void start_client(MQTT_CLIENT_DATA_T *state) {
    ...
    //state->message_semaphore = xSemaphoreCreateBinary(); // Inicializa o semáforo
    //state->message_queue = xQueueCreate(10, sizeof(char[256])); // Ajuste o tamanho conforme necessário
